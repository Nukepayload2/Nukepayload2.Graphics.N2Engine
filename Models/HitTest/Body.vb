...
Namespace Global.Box2D
    Public Class Body
        ...
        Public Function GetAngularDamping() As Single
            Return Me._angularDamping
        End Function

        Public Function GetAngularVelocity() As Single
            Return Me._angularVelocity
        End Function

        Public Function GetConactList() As ContactEdge
            Return Me._contactList
        End Function

        Public Function GetFixtureList() As Fixture
            Return Me._fixtureList
        End Function

        Public Function GetInertia() As Single
            Return Me._I
        End Function

        Public Function GetJointList() As JointEdge
            Return Me._jointList
        End Function

        Public Function GetLinearDamping() As Single
            Return Me._linearDamping
        End Function

        Public Function GetLinearVelocity() As Vector2
        ...
        Public Function GetWorldCenter() As Vector2
            Return Me._sweep.c
        End Function

        Public Function GetWorldPoint(ByVal localPoint As Vector2) As Vector2
        ...
        Public Sub SetAngularDamping(ByVal angularDamping As Single)
            Me._angularDamping = angularDamping
        End Sub

        Public Sub SetAngularVelocity(ByVal omega As Single)
            Me._angularVelocity = omega
        End Sub
        ...
        Public Sub SetLinearDamping(ByVal linearDamping As Single)
            Me._linearDamping = linearDamping
        End Sub

        Public Sub SetLinearVelocity(ByVal v As Vector2)
            Me._linearVelocity = v
        End Sub
